  ...
  return (
    <div className="my-8 not-prose">
      ...
      <div className={`${CARD} overflow-hidden`}>
        <div className="flex items-center justify-between px-4 py-2 bg-zinc-50 dark:bg-neutral-800/60 border-b border-zinc-100 dark:border-neutral-800">
        ...
        <div className="p-4 bg-zinc-950 dark:bg-neutral-900 font-mono text-sm">
    ...
    <div className="my-8 not-prose">
      ...
      {commands.length > 4 && (
        <input
          ...
          placeholder="Search…"
          className="w-full mb-3 px-3 py-2 text-xs font-mono border border-zinc-100 dark:border-neutral-800 rounded-lg bg-transparent text-zinc-700 dark:text-neutral-300 placeholder-zinc-400 focus:outline-none"
        />
      )}
      <div className={`${CARD} divide-y divide-zinc-100 dark:divide-neutral-800`}>
        {f.map((c) => (
          <div
            key={c.cmd}
            className="group flex items-center gap-3 px-4 py-2.5 hover:bg-zinc-50 dark:hover:bg-neutral-800/30 transition-colors"
          >
            <code className="text-xs font-mono text-zinc-800 dark:text-neutral-200 flex-shrink-0 max-w-[45%] truncate">
              {c.cmd}
            </code>
            <span className="text-xs text-zinc-400 dark:text-neutral-400 flex-1 min-w-0 truncate">
              {c.desc}
            </span>
            <button
