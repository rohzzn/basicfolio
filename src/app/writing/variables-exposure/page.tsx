    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-white">Your Environment Variables Are Lying to You</h1>
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-white">Breaking Into My Own App</h2>
        <p className="text-zinc-600 dark:text-zinc-400 mb-4 text-sm">
        ...
        <h3 className="text-sm font-medium mt-6 mb-3 dark:text-white">The Setup: A Perfect Storm</h3>
        <p className="text-zinc-600 dark:text-zinc-400 mb-4 text-sm">
        ...
        <h3 className="text-sm font-medium mt-6 mb-3 dark:text-white">The Hunt: Following the Data</h3>
        <p className="text-zinc-600 dark:text-zinc-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-white">How to Actually Keep Secrets</h2>
        <p className="text-zinc-600 dark:text-zinc-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-white">The New Reality</h2>
        <p className="text-zinc-600 dark:text-zinc-400 mb-4 text-sm">
