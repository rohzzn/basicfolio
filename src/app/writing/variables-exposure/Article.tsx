    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">Your Environment Variables Are Lying to You</h1>
      ...
      <PostFilm slug="variables-exposure" />
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h3 className="text-sm font-medium mt-6 mb-3 dark:text-paper">The Setup: A Perfect Storm</h3>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h3 className="text-sm font-medium mt-6 mb-3 dark:text-paper">The Hunt: Following the Data</h3>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">The Wake-Up Call</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">How to Actually Keep Secrets</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
          After thoroughly breaking my own security, I put together a battle plan for keeping sensitive data actually sensitive:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">The New Reality</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
