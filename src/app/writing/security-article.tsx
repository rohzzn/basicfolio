...
const SecurityArticle: React.FC<ArticleProps> = ({ onBack }) => {
  return (
    <article className="max-w-2xl mx-auto py-8">
      ...
      <header className="mb-8">
        <h1 className="text-3xl font-bold mb-2 dark:text-white">
          Your 2FA Is Broken: Inside the New Wave of Time-Based Token Attacks
        </h1>
      ...
      <div className="prose dark:prose-invert prose-zinc max-w-none">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 dark:text-white">The Discovery</h2>
        ...
        <div className="bg-zinc-100 dark:bg-zinc-800 p-6 rounded-lg mb-8">
          <h3 className="text-lg font-semibold mb-4 dark:text-white">Vulnerable Implementation</h3>
...
function verifyTOTP(token: string, secret: string): boolean {
  ...
  return token === currentToken;
        ...
        <div className="bg-zinc-100 dark:bg-zinc-800 p-6 rounded-lg mb-8">
          <h3 className="text-lg font-semibold mb-4 dark:text-white">Secure Implementation</h3>
          <pre className="bg-black text-green-400 p-4 rounded overflow-x-auto">
...
function updateDriftCompensation(drift: number): void {
  ...
  driftCompensation.set(userId, newDrift);
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 dark:text-white">The Attack Vectors</h2>
        <p className="text-zinc-600 dark:text-zinc-400 mb-6">
          Here&#39;s where it gets interesting. I found three main attack vectors that exploit common implementation flaws:
        </p>

        <div className="bg-zinc-100 dark:bg-zinc-800 p-6 rounded-lg mb-8">
          <h3 className="text-lg font-semibold mb-4 dark:text-white">1. Time-Drift Manipulation</h3>
          <pre className="bg-black text-green-400 p-4 rounded overflow-x-auto">
...
async function exploitTimeDrift(targetEndpoint: string): Promise<void> {
  ...
  while (currentDrift < MAX_DRIFT) {
    ...
    currentDrift += 30; // 30-second increments
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 dark:text-white">The Solution</h2>
        <p className="text-zinc-600 dark:text-zinc-400 mb-6">
        ...
        <div className="bg-zinc-100 dark:bg-zinc-800 p-6 rounded-lg mb-8">
          <h3 className="text-lg font-semibold mb-4 dark:text-white">TOTP Security Scanner</h3>
          <pre className="bg-black text-green-400 p-4 rounded overflow-x-auto">
