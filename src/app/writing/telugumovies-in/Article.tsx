    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          ...
          <Link
            href="/writing"
            className="text-xs text-zinc-400 dark:text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors flex-shrink-0 mt-1"
          >
            writing
          </Link>
        </div>
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-white">The NAS dream and the storage math</h2>
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-white">What telugumovies.in actually is</h2>

        <p className="text-zinc-600 dark:text-zinc-400 mb-4 text-sm">
          While the NAS idea was on pause, I built something smaller:{' '}
          <a
            href="https://telugumovies.in"
            className="underline decoration-zinc-300 dark:decoration-zinc-600 underline-offset-2 hover:decoration-zinc-500"
            target="_blank"
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-white">Why I paused it</h2>
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-white">What I would do differently</h2>
