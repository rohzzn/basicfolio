    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">Apple&apos;s Best AI Feature Is Not Siri</h1>
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">What Actually Shipped</h2>
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Why This Is Harder Than Siri</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Where It Breaks</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Why Siri Is Not It</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <div className="bg-zinc-100 dark:bg-neutral-800 p-6 rounded-lg mb-8">
          <h3 className="text-sm font-medium mb-4 dark:text-paper">Bounded agent vs open-ended agent</h3>
...
passwords.fix(account)
  ...
  → user evaluates one outcome, not every step`}
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">The Part Nobody Is Covering</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">What Good Agentic AI Looks Like</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
