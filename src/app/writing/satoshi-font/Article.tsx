    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">Why I Use Satoshi on Everything I Build</h1>
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">What Satoshi is</h2>
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">Why it works so well for UI</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">Compared to the obvious alternatives</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">Where it falls short</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
          The other limitation is that because Fontshare hosts it, you are adding a third-party dependency. For maximum reliability I self-host the font files — the repository for this site includes the full Satoshi web font package in <code className="font-mono text-xs bg-zinc-100 dark:bg-neutral-800 px-1 py-0.5 rounded">public/font/</code> so it loads from the same origin as everything else and is not affected by Fontshare availability.
        </p>

        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">The practical setup</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
          Loading Satoshi in a Next.js project with self-hosted files looks like this. Declare the font faces in your CSS pointing at the local files, set it as the default <code className="font-mono text-xs bg-zinc-100 dark:bg-neutral-800 px-1 py-0.5 rounded">font-family</code> on the body, and add it to your Tailwind config so you can use it with utility classes.
        </p>

        <div className="bg-zinc-100 dark:bg-neutral-800 rounded-lg p-4 mb-6">
          <pre className="text-xs text-zinc-600 dark:text-neutral-400 overflow-x-auto">{`/* globals.css */
@font-face {
  font-family: 'Satoshi';
