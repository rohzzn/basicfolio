    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">Building My Own ChatGPT UI</h1>
      ...
      <PostFilm slug="chatgpt-interface" />
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Streaming is Not Optional</h2>
        ...
        <div className="bg-zinc-100 dark:bg-neutral-800 p-6 rounded-lg mb-8">
          <h3 className="text-sm font-medium mb-4 dark:text-paper">Streaming response in a Next.js route handler</h3>
...
export async function POST(req: Request) {
  ...
  return new Response(readable, {
    headers: { 'Content-Type': 'text/plain; charset=utf-8' },
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">System Prompts Per Context</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
