    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">Beginners Guide for Design</h1>
      ...
      <PostFilm slug="beginners-guide-design" />
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Learn Figma. Skip everything else for now.</h2>
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Study before you copy</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
          The fastest way to develop taste is to look at a lot of good work and understand why it works. Not just passively scrolling Dribbble, but actually asking: what makes this feel clean? Why do the sections feel well-separated? What is the visual hierarchy? Sites like <a href="https://www.mobbin.com" target="_blank" rel="noopener noreferrer" className="text-zinc-700 dark:text-neutral-300 hover:text-zinc-900 dark:hover:text-paper transition-colors">Mobbin</a> and <a href="https://www.awwwards.com" target="_blank" rel="noopener noreferrer" className="text-zinc-700 dark:text-neutral-300 hover:text-zinc-900 dark:hover:text-paper transition-colors">Awwwards</a> are useful references. For UI patterns specifically, Mobbin captures real interfaces from real apps, which is more useful than design awards that often prioritize visual novelty over usability.
        </p>

        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">The four principles that cover most problems</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
