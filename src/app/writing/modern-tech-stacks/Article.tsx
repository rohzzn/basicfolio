    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">Modern Tech Stacks Kill Startups</h1>
      ...
      <PostFilm slug="modern-tech-stacks" />
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">The Pattern</h2>
        ...
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
          The counterintuitive insight is that boring technology often scales better in practice than the modern alternative, at least for the first few years. PHP and MySQL run <a href="https://www.facebook.com" className="text-zinc-700 dark:text-neutral-300 hover:text-zinc-900 dark:hover:text-paper transition-colors" target="_blank" rel="noopener noreferrer">Facebook</a> at its beginning. Rails ran GitHub for a long time. The technology is not the constraint. The constraint is that you have not found product-market fit yet, which means you cannot predict what you need to scale.
        </p>

        <CostComparison />

        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">The Hidden Cost of Complexity</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">What Actually Matters Early</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Exceptions</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
