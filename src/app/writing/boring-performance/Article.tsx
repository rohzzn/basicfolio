...
const BoringPerformance: React.FC = () => {
  return (
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      ...
      <PostFilm slug="boring-performance" />
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">The Bundle Size Problem</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
          Unused code is probably responsible for a larger share of your bundle than you think. A typical React app imports a full UI library to use three components. It ships development-mode warnings. It includes every locale string for a date library when you only need English. The fastest way to audit this is to run <code className="font-mono text-xs bg-zinc-100 dark:bg-neutral-800 px-1 py-0.5 rounded">npx @next/bundle-analyzer</code> or the webpack bundle analyzer and look for anything suspiciously large. You will almost always find something that can be swapped for a smaller alternative or lazy-loaded.
        </p>

        <div className="bg-zinc-100 dark:bg-neutral-800 p-6 rounded-lg mb-8">
          <h3 className="text-sm font-medium mb-4 dark:text-paper">Code splitting with Next.js dynamic imports</h3>
...
const Chart = dynamic(() => import('./HeavyChart'), {
  ...
  ssr: false,
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Memory Leaks in React</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
          The most common memory leak I have seen is a missing cleanup in a <code className="font-mono text-xs bg-zinc-100 dark:bg-neutral-800 px-1 py-0.5 rounded">useEffect</code>. You set up an interval or subscription, but you never return a cleanup function. The component unmounts but the timer keeps running, keeping references to stale state alive. If this happens in a list that mounts and unmounts a lot you will see memory grow over time.
        </p>
...
useEffect(() => {
  ...
  return () => clearInterval(interval);
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Network: The Biggest Win Nobody Does</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <div className="bg-zinc-100 dark:bg-neutral-800 p-6 rounded-lg mb-8">
          <h3 className="text-sm font-medium mb-4 dark:text-paper">vercel.json cache configuration</h3>
          <pre className="bg-zinc-900 text-zinc-200 p-4 rounded overflow-x-auto text-xs">
{`{
  "headers": [
    {
    ...
    },
    {
      ...
      "headers": [
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Measure Before Optimizing</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">What these changes actually look like</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Where to start</h2>
