    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">Building a Linux Home Server</h1>
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">The case for self-hosting</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">The hardware</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">What I want to run</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Storage</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Everything runs in Docker</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">How traffic gets routed</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">What could go wrong</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">When it actually happens</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
