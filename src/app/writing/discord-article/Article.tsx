    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">How Discord Survived 2024s Biggest Launch</h1>
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">The Problem With Gaming Launches</h2>
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">How Discord Shards Its Gateway</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <div className="bg-zinc-100 dark:bg-neutral-800 p-6 rounded-lg mb-8">
          <h3 className="text-sm font-medium mb-4 dark:text-paper">The architecture tradeoff in simplified form</h3>
...
// No GC, no unpredictable pauses at peak load`}
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Rate Limiting at Scale</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <div className="bg-zinc-100 dark:bg-neutral-800 p-6 rounded-lg mb-8">
          <h3 className="text-sm font-medium mb-4 dark:text-paper">Sliding window rate limiter in Redis</h3>
          <pre className="bg-zinc-900 text-zinc-200 p-4 rounded overflow-x-auto text-xs">
...
return 1`}
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">What Makes This Hard</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
