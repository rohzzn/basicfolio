    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">Everything This Site Loads Over the Wire</h1>
      ...
      <div className="text-sm max-w-3xl">
        ...
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
          The pattern for most of them is the same: client makes a request to <code className="font-mono text-xs bg-zinc-100 dark:bg-neutral-800 px-1 py-0.5 rounded">/api/[service]</code>, the route authenticates with the upstream API using an environment variable, processes the response, and returns cleaned JSON. This keeps credentials off the client and lets me add caching, rate limiting, or content filtering server-side before the data reaches the page.
        </p>
