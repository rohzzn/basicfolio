    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">Software I Admire That I Didn&apos;t Write</h1>
      ...
      <PostFilm slug="software-i-admire" />
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-10 mb-4 dark:text-paper">What the C programs have in common</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">What the Rust tools changed</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
