    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">Beginners Guide for Programming</h1>
      ...
      <PostFilm slug="beginners-guide-programming" />
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Learn to read errors before anything else</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Use Git from day one</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
          I did not start using Git until embarrassingly late and I regret it. You do not need to understand branching or rebasing right away. Just learn <code className="font-mono text-xs bg-zinc-100 dark:bg-neutral-800 px-1 py-0.5 rounded">git init</code>, <code className="font-mono text-xs bg-zinc-100 dark:bg-neutral-800 px-1 py-0.5 rounded">git add</code>, <code className="font-mono text-xs bg-zinc-100 dark:bg-neutral-800 px-1 py-0.5 rounded">git commit</code>, and <code className="font-mono text-xs bg-zinc-100 dark:bg-neutral-800 px-1 py-0.5 rounded">git push</code>. Commit every time you make something work. Put every project on GitHub. When you break something, you can always go back. When you are applying for jobs, you have a public record of what you have built.
        </p>

        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">The path that worked for me</h2>
