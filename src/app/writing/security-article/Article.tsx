  ...
  return (
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">How TOTP Is Supposed to Work</h2>
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">The Drift Problem</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <div className="bg-zinc-100 dark:bg-neutral-800 p-6 rounded-lg mb-8">
          <h3 className="text-sm font-medium mb-4 dark:text-paper">Vulnerable vs correct TOTP check</h3>
...
function verifyTOTPSecure(token: string, secret: string): boolean {
  ...
  return false;
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">Replay Attacks</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <div className="bg-zinc-100 dark:bg-neutral-800 p-6 rounded-lg mb-8">
          <h3 className="text-sm font-medium mb-4 dark:text-paper">Adding replay protection</h3>
          <pre className="bg-zinc-900 text-zinc-200 p-4 rounded overflow-x-auto text-xs">
...
async function verifyWithReplayProtection(
  ...
  return true;
        ...
        <h2 className="text-base font-medium mt-8 mb-4 dark:text-paper">What This Means Practically</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4 text-sm">
        ...
        <p className="text-zinc-600 dark:text-neutral-400 text-sm">
          If you are using a library, check that it implements drift compensation. Most well-maintained TOTP libraries (like <code className="font-mono text-xs bg-zinc-100 dark:bg-neutral-800 px-1 py-0.5 rounded">speakeasy</code> in Node or <code className="font-mono text-xs bg-zinc-100 dark:bg-neutral-800 px-1 py-0.5 rounded">pyotp</code> in Python) do this correctly by default. The danger is rolling your own without reading the spec carefully.
        </p>
      </div>
    </article>
  );
