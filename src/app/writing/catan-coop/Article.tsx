    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">Building Multiplayer Catan From Scratch</h1>
        ...
        <div className="flex items-center gap-4 text-zinc-600 dark:text-neutral-400 text-sm">
          ...
          <a href="https://catan.rohan.run" target="_blank" rel="noopener noreferrer"
             className="text-zinc-500 hover:text-zinc-700 dark:hover:text-neutral-300 transition-colors text-xs">
            catan.rohan.run ↗
          </a>
        </div>
      </header>
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">The board</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">Making the geometry work</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">Numbers and probability</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">Building rules</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">Longest road is harder than it looks</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">Hidden victory points</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">Sound without audio files</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">Deployment</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
