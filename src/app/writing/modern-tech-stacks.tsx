...
const ModernTechStacks: React.FC<ArticleProps> = ({ onBack }) => {
  return (
    <article className="max-w-2xl mx-auto py-8">
      ...
      <header className="mb-8">
        <h1 className="text-3xl font-bold mb-2 dark:text-white">
          Modern Tech Stacks Are Killing Your Startup — Here&#39;s What We Learned Building With PHP in 2024
        </h1>
      ...
      <div className="prose dark:prose-invert prose-zinc max-w-none">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 dark:text-white">The Decision That Saved Us</h2>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 dark:text-white">The Results That Shocked Us</h2>
        <p className="text-zinc-600 dark:text-zinc-400 mb-6">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 dark:text-white">The Modern Stack Tax</h2>
        <p className="text-zinc-600 dark:text-zinc-400 mb-6">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 dark:text-white">But What About Scale?</h2>
        <p className="text-zinc-600 dark:text-zinc-400 mb-6">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 dark:text-white">The Real Innovation Tax</h2>
        <p className="text-zinc-600 dark:text-zinc-400 mb-6">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 dark:text-white">When You Should Ignore This Advice</h2>
        <p className="text-zinc-600 dark:text-zinc-400 mb-6">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg mb-8">
          <h3 className="text-lg font-semibold mb-4 dark:text-white">Key Takeaways</h3>
          <ul className="list-disc pl-6 space-y-2 text-zinc-600 dark:text-zinc-400">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 dark:text-white">The Path Forward</h2>
