    ...
    <article className="max-w-3xl pb-8 pt-0 px-4 sm:px-0">
      <header className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h1 className="text-lg font-medium dark:text-paper">What I Learned Building 40 Side Projects</h1>
      ...
      <div className="text-sm max-w-3xl">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">The projects that got traction shared one thing</h2>
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">Technology choices mostly do not matter at the start</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">The ones I am proudest of are not the most popular</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
        ...
        <h2 className="text-base font-medium mt-8 mb-3 dark:text-paper">What I would tell myself at project one</h2>
        <p className="text-zinc-600 dark:text-neutral-400 mb-4">
