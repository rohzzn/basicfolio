          ...
          <div className="flex w-full min-w-0 flex-col items-start gap-4">
            ...
            {activePost && heroDuplexForUi ? (
                <button
                  ...
                  className="group relative block w-full max-w-sm outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] dark:focus-visible:ring-neutral-500"
                >
