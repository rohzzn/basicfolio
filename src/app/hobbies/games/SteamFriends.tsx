...
const SteamFriends: React.FC<SteamFriendsProps> = ({ friends: initialFriends }) => {
  ...
  // Function to manually refresh friends data
  ...
  // Other online friends (not playing games)
    ...
    <div className="bg-zinc-100 dark:bg-zinc-800 rounded-lg p-4 h-full flex flex-col">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <button 
          ...
          className="flex items-center text-xs text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200 disabled:opacity-50"
        >
      ...
      {onlineFriends.length > 0 && (
        <div className="mt-3 pt-3 border-t border-zinc-200 dark:border-zinc-700">
          ...
          <div className="flex flex-wrap gap-1.5 overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-zinc-300 dark:scrollbar-thumb-zinc-600">
      ...
      {/* Removed All Friends section as requested */}
    </div>
  );
};
