...
const MedalClip: React.FC<MedalClipProps> = ({
  ...
  return (
    <div className="flex flex-col rounded-lg overflow-hidden bg-zinc-100 dark:bg-neutral-800 hover:bg-zinc-200 dark:hover:bg-neutral-700 transition-colors">
      <Link 
      ...
      <div className="p-4">
        <h3 className="text-sm font-medium text-zinc-800 dark:text-paper truncate" title={contentTitle}>
          {contentTitle}
        </h3>
