      ...
      >
        <div className="border-b border-zinc-200 dark:border-zinc-700 flex items-center px-3">
          ...
          <Command.Input
            ...
            placeholder="Search pages, features, navigation..."
          ...
          <Command.Group heading="Actions" className="text-xs font-medium text-zinc-500 dark:text-zinc-400 px-2 pb-1 pt-2">
            {quickLinks.map((item, index) => (
              <Command.Item
                ...
                className="flex items-center gap-2 px-2 py-2 text-sm rounded-lg cursor-pointer text-zinc-700 dark:text-zinc-200 hover:bg-zinc-200 dark:hover:bg-zinc-700 aria-selected:bg-zinc-200 dark:aria-selected:bg-zinc-700 aria-selected:!text-zinc-900 dark:aria-selected:!text-zinc-100"
              >
